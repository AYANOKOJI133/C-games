...
int main(){
    ...
    do{
        ...
        start_time = clock();
        char toucheAttendue_1 = 'A';
        char toucheAttendue_2 = 'P';
        while(click_1<40 && click_2<40){
            system("cls");
            ...
            //click++ ;
            touche = _getch();
            if (touche == toucheAttendue_1 || touche == toucheAttendue_1 + 32) {
                system("cls");
                SetConsoleTextAttribute(hConsole, FOREGROUND_RED | FOREGROUND_GREEN);
                fram(click_1);
               SetConsoleTextAttribute(hConsole, FOREGROUND_BLUE | FOREGROUND_INTENSITY);
                ...
                SetConsoleTextAttribute(hConsole, FOREGROUND_RED | FOREGROUND_GREEN | FOREGROUND_BLUE);
                click_1++;
            } else if (touche == toucheAttendue_2 || touche == toucheAttendue_2 + 32) {
                system("cls");
                SetConsoleTextAttribute(hConsole, FOREGROUND_RED | FOREGROUND_GREEN);
                fram(click_1);
                SetConsoleTextAttribute(hConsole, FOREGROUND_BLUE | FOREGROUND_INTENSITY);
